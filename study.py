...
# Необходимо ее раскодировать, используя азбуку Морзе.
# s = ".-- ... . -...- .-- . .-. -. ---".split(' ')
...
# t = tuple(input().split())   #  Воронеж Самара Тольятти Ульяновск Пермь
# city = 'Ульяновск'
# m_t = tuple(item for item in t if item != city)
# print(*m_t)
...
# t = tuple(map(int, input().split()))   #  5 4 -3 2 4 5 10 11
# l_n = []
# for i, el in enumerate(t):
#     if t.count(el) > 1:
#         l_n.append(t.index(el, i))
#
# print(*l_n)
...
# l = list(input())  # Python 3.9.11 - best language!
# s = set()
#
# for i in l:
#     if i.isdigit():
...
# Вводится строка со списком оценок.
...
n = ['1', 'ужасно', 'неудовлетворительно', 'удовлетворительно', 'прилично', 'отлично']
r = int(n[0])
n = n[1:]
d = {}
